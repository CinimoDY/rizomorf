class ButtonBrandSubtleL extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this.button.className = 'button-brand-subtle-l';
    
    // Create icon container
    const iconContainer = document.createElement('div');
    iconContainer.className = 'button-brand-subtle-l__icon';
    
    // Create icon inner element
    const iconInner = document.createElement('div');
    iconInner.className = 'button-brand-subtle-l__icon-inner';
    ...
    textContainer.className = 'button-brand-subtle-l__text';
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (name === 'disabled') {
      ...
      this.button.classList.toggle('button-brand-subtle-l--loading', this.isLoading);
...
customElements.define('button-brand-subtle-l', ButtonBrandSubtleL); 
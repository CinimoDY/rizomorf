class DosButton extends HTMLElement {
  constructor() {
    super();
  ...
  connectedCallback() {
    ...
    this.button.className = 'dos-button';
    
    // Create icon container
    const iconContainer = document.createElement('div');
    iconContainer.className = 'dos-button__icon';
    
    // Create icon inner element
    const iconInner = document.createElement('div');
    iconInner.className = 'dos-button__icon-inner';
    ...
    textContainer.className = 'dos-button__text';
  ...
  attributeChangedCallback(name, oldValue, newValue) {
    ...
    if (name === 'disabled') {
      ...
      this.button.classList.toggle('dos-button--loading', this.isLoading);
  ...
  handleClick(event) {
    ...
    this.dispatchEvent(new CustomEvent('dos-click', {
      bubbles: true,
      cancelable: true,
...
customElements.define('dos-button', DosButton); 